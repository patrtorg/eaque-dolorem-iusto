# @patrtorg/eaque-dolorem-iusto

![CI](https://github.com/patrtorg/eaque-dolorem-iusto/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@patrtorg/eaque-dolorem-iusto.svg?style=flat)](https://www.npmjs.com/package/@patrtorg/eaque-dolorem-iusto)
...
```
npm i @patrtorg/eaque-dolorem-iusto
```
...
const autoload = require('@patrtorg/eaque-dolorem-iusto')
...
```js
import autoLoad from '@patrtorg/eaque-dolorem-iusto'
...
- `opts.dependencies` - Set plugin dependencies to ensure correct load order
  ...
  Plugins and hooks are encapsulated together by folder and registered on the `fastify` instance which loaded the `@patrtorg/eaque-dolorem-iusto` plugin. For more information on how encapsulation works in Fastify, see: https://fastify.dev/docs/latest/Reference/Encapsulation/#encapsulation
